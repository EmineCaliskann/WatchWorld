...
namespace Web.Models
{
    public class PaginationInfoViewModel
    {
        ...
        public int[] PageNumbers => Pagination(PageId, TotalPages); //1 -1 5 6 7 8 9 -1 12  -1 yerine 3 nokta &hellip;
        ...
        {
            int delta = 2;//mevcut seçili sayının solunu ve sağını 2 göstersin
